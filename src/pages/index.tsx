				...
				<Article>
					<ArticleSection>
						...
						<p>
							...
							criada em 1988 pelo italiano Francesco Cirillo, dono de uma
							empresa de consultoria sediada em Berlim, na Alemanha. Cirillo é
							autor do livro The Pomodoro Technique (ou “A técnica pomodoro”),
							publicado no Brasil pela editora Sextante. Ele diz que desenvolveu
							o método depois de descobrir que era possível melhorar a
							produtividade registrando quanto tempo uma tarefa leva para ser
							concluída e aprendendo a controlar todas as tarefas do dia a dia.
						</p>
						<br />
						<p>
							O método pomodoro consiste em realizar uma tarefa por vez, em
							períodos de 25 minutos ininterruptos, evitando distrações e a
							prática da procrastinação. Cada “pomodoro” realizado deve ser
							intercalado com uma pausa de 5 minutos. A cada quatro pomodori,
							você pode fazer uma pausa maior, de 15 a 30 minutos, como
							recompensa. O método completo dura duas horas.
						</p>
						<p>
							Pomodoro, em italiano, significa tomate, no singular. No método
							pomodoro, o tempo é dividido em períodos de 25 minutos. A cada
							quatro pomodori (ou seja, “quatro tomatinhos”, no plural), você
							completa um pomodoro. Este é método simples que pode facilitar
							muito o cumprimento das suas metas diárias.
						</p>
					</ArticleSection>
					...
					<ArticleSection>
						...
						<ol>
							...
							<li>
								Faça a pausa de cinco minutos, mesmo que você não tenha chegado
								a cumprir a tarefa no período de 25 minutos.
							</li>
							<li>
							...
							<li>
								...
								divididas. Se, eventualmente, você passar o período de 25
								minutos em uma tarefa, aplique uma pausa mais longa para
								compensar. Por exemplo, se você demorar meia hora para completar
								uma tarefa, faça uma pausa de 10 minutos. O ideal é nunca
								ultrapassar o tempo estabelecido, para não perder o controle da
								programação.
							</li>
							<li>
								Evite interromper a atividade que você se dispôs a fazer durante
								um pomodoro. Pode ser tentador parar sua atividade para atender
								o telefone, verificar e-mails ou mensagens no WhatsApp, por
								exemplo, mas tente anotar essas atividades para fazê-las depois.
								Para isso, você pode utilizar papel e caneta, uma agenda ou um
								organizador de tarefas digital.
							</li>
							<li>
								...
								as interrupções (internas ou externas) à medida que elas ocorrem
								e reflita sobre como evitá-las na próxima sessão.
							</li>
							<li>
